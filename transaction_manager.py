...
class TransactionManager:
    ...
    def process(self, transaction_id, operation, resource, lock_manager, deadlock_manager, transaction_manager, lock_manager, schedule):
        ...
        if operation == 'R':
            return lock_manager.acquire_shared_lock(transaction_id, resource, deadlock_manager)
        elif operation == 'W':
            return lock_manager.acquire_exclusive_lock(transaction_id, resource, deadlock_manager)
        elif operation == 'U':
